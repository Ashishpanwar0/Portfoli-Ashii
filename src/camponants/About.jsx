  ...
  return (
    <>
      <section id="About" className='pt-10'>
        <div className='text-center text-5xl mb-5 text-[#A78BFA]' data-aos="fade-up">
          <h1>About</h1>
        </div>
      
        <div className="p-6" data-aos="fade-up">
          {/* Buttons start */}
          <div className="flex justify-center mb-6 space-x-4" data-aos="zoom-in">
            <button
              onClick={() => setActiveTab('skills')}
              className={`px-5 py-2 rounded-lg transition-all duration-300 ${
                activeTab === 'skills' ? 'bg-[#A78BFA] text-black' : 'bg-gray-200 text-black'
              }`}
            >
              Education
            </button>
            <button
              ...
              className={`px-10 py-2 rounded-lg transition-all duration-300 ${
                activeTab === 'education' ? 'bg-[#A78BFA] text-black' : 'bg-gray-200 text-black'
              }`}
            >
              Skills
            </button>
          ...
          <div className="lg:ml-10">
            {activeTab === 'education' && (
              <>
                ...
                <div className='lg:block hidden'>
                  <div className='grid lg:grid-cols-5 lg:w-[100%] lg:space-x-18 gap-x-5 space-y-5 mt-10' data-aos="fade-up">
                  ...
                  <div className='grid lg:grid-cols-5 grid-cols-3 w-[100%] h-[200px] lg:space-x-18 gap-x-5 space-y-5 lg:mt-10' data-aos="fade-up">
            ...
            {activeTab === 'skills' && (
              <div className='lg:flex lg:gap-x-1' data-aos="fade-up">
                <div>
                ...
                <div>
                  <ul className="space-y-8 lg:mt-8">
                    <li data-aos="fade-right">
                      ...
                      <strong className='flex gap-x-5 mt-2 text-white text-sm'>
                        <img src={computerguru} alt="" className='w-22 rounded-sm mt-[-38px]' />
                        Computer Guru Training Institute <br /> (1 Year Diploma)
                      </strong>
                    </li>
                    <li data-aos="fade-left">
                      <strong className='ml-27 text-xl lg:text-2xl text-white'>Information <span className='lg:ml-0 ml-26 sm:ml-0'>Technology</span></strong><br />
                      <strong className='flex gap-x-5 mt-2 text-white text-sm'>
                        <img src={uou} alt="" className='w-22 rounded-sm lg:mt-[-40px] mt-[-52px]' />
                        Uttrakhand Open University<br /> (1 Year Diploma)
                      </strong>
                    </li>
                    <li data-aos="fade-right">
                      <strong className='ml-27 text-xl lg:text-2xl text-white'>Bachelor Of Art</strong><br />
                      <strong className='flex gap-x-5 mt-2 text-white text-sm'>
                        <img src={uou} alt="" className='w-22 rounded-sm mt-[-40px]' />
                        Uttrakhand Open University<br /> (Graduation)
                      </strong>
                    </li>
                    <li data-aos="fade-left">
                      <strong className='ml-27 text-xl lg:text-2xl text-white'>12th</strong><br />
                      <strong className='flex gap-x-5 lg:mt-1 text-white text-sm'>
                        <img src={saraswati} alt="" className='w-22 rounded-sm mt-[-40px]' />
                        Saraswati Vidhya Mandir<br /> (2021 with 70%)
                      </strong>
                    </li>
                  </ul>
                </div>
