            ...
            <div className='mt-15 space-y-12'>
               {/* 1st */}
                   <div className='lg:flex lg:gap-x-37 w-[100%] items-center'>
                        <a href="https://yogni.netlify.app/" target="_blank" className='lg:ml-15 '><img src={project3} alt="" className='lg:w-[400px] rounded-[10px] scale-100 opacity-80 hover:opacity-50 w-[94%] lg:mb-2 mb-3 ml-3 lg:ml-0'/></a>
                        ...
                        <div className='text-[#e2e8f0b6] lg:w-[50%] text-justify border-1 hover:border-[#122044a4] hover:bg-[#172649] border-[#12204402] px-5 py-2 rounded-xl'>
                            ...
                            <ul className='grid lg:grid-cols-4 grid-cols-2 gap-5'>
                              <li className='border-1 py-1 rounded-xl items-center text-center border-[#12204402] bg-[#183656] text-[#4EC1C6]'>PHP (Backend)</li>
                              <li className='border-1 py-1 rounded-xl items-center text-center border-[#12204402] bg-[#183656] text-[#4EC1C6]'>MySQL (Database)</li>
                              <li className='border-1 py-1 rounded-xl items-center text-center border-[#12204402] bg-[#183656] text-[#4EC1C6]'>Tailwind CSS </li>
                              <li className='border-1 py-1 rounded-xl items-center text-center border-[#12204402] bg-[#183656] text-[#4EC1C6]'>HTML (Frontend)</li>
                               <li className='border-1 py-1 rounded-xl items-center text-center border-[#12204402] bg-[#183656] text-[#4EC1C6]'> Font Awesome</li>
                            </ul>
                        </div>
                  </div>
